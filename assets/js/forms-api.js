! function() {
  ...
  ! function n(t, r, i) {
    ...
    1: [function(e, t, n) {
      ...
      function o(e, t) {
        return function() {
          var n = this.value.trim(),
            r = "radio" !== this.getAttribute("type") && "checked" !== this.getAttribute("type") || this.checked,
            i = r && (n === t || "" === t && n.length > 0);
      ...
      if (window.addEventListener) {
        var c = e("gator"),
          ...
          l = document.querySelectorAll(".mc4wp-form [data-show-if]");
    ...
    3: [function(e, t, n) {
      ...
      function i(e) {
        for (var t = e.form || e, n = 0; n < d.length; n++)
        ...
        o.getListeners = function(e) {
          ...
          for (o in c)
            if (c.hasOwnProperty(o))
              for (n = c[o].slice(0), i = n.length; i--;) r = n[i], r.once === !0 && this.removeListener(e, r.listener), s = r.listener.apply(this, t || []), s === this._getOnceReturnValue() && this.removeListener(e, r.listener);
          return this
