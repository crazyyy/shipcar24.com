(function() {
  ...
  var optimizelyCode = function() {
    var DATA = {
      ...
      "goal_expressions": {
        "5353611873": ["^quote\\-button\\-clicks\\-b$"],
        "5137830178": ["^engagement$"],
        "5262623250": ["^(https?://)?(www\\.)?montway\\.com\\/get\\-a\\-quote/?(\\?.*)?(#.*)?$"],
        "5258102419": ["^quote\\_button\\_clicks$"],
        "5647290901": ["^bottom\\_cta\\_clicks\\_\\(home\\_page\\)$"],
        "5338670135": ["^(https?://)?(www\\.)?montway\\.com\\/quote\\/shipping\\-rates/?(\\?.*)?(#.*)?$"],
        "5349270105": ["^(https?://)?(www\\.)?montway\\.com\\/quote\\/receipt/?(\\?.*)?(#.*)?$"],
        "5676650043": ["^header\\_cta\\_clicks\\_\\(home\\_page\\)$"],
        "5624262748": ["^button\\_clicks\\_\\(home\\_page\\)$"],
        "5263413118": ["^request\\_a\\_call$"]
      },
      "experiments": {
        "5911971225": {
          "audiences": [5401990032],
          "name": "LP vs LP-6 (Desktop)",
          "variation_ids": ["5912971161", "5923621110"],
          "urls": [{
            "match": "simple",
            "value": "https://www.montway.com/car-shipping-lp"
          }],
          "enabled_variation_ids": ["5912971161", "5923621110"]
        },
        "7839751210": {
          "audiences": [5401990032],
          "name": "LP vs LP-8 (Desktop)",
          "variation_ids": ["7847340857", "7832900768"],
          "urls": [{
            "match": "simple",
            "value": "https://www.montway.com/car-shipping-lp"
          }],
          "enabled_variation_ids": ["7847340857", "7832900768"]
        },
        "5623621803": {
          "name": "Home page CTA buttons color change",
          "variation_ids": ["5623621804", "5634881483", "5676850308", "5675100393"],
          "urls": [{
            "match": "simple",
            "value": "https://www.montway.com/"
          }],
          "enabled_variation_ids": ["5623621804", "5634881483", "5676850308", "5675100393"]
        },
        "5919251369": {
          "audiences": [5404510864],
          "name": "LP-3 vs LP-6 (MOBILE - no TABLETS)",
          "variation_ids": ["5923621135", "5923481203"],
          "urls": [{
            "match": "simple",
            "value": "https://www.montway.com/car-shipping-lp-3"
          }],
          "enabled_variation_ids": ["5923621135", "5923481203"]
        },
        "7824878294": {
          "audiences": [5404510864],
          "name": "LP-3 vs LP-8 (MOBILE - no TABLETS)",
          "variation_ids": ["7840951767", "7838875180"],
          "urls": [{
            "match": "simple",
            "value": "https://www.montway.com/car-shipping-lp-3"
          }],
          "enabled_variation_ids": ["7840951767", "7838875180"]
        }
      },
      "audiences": {
        "5401990032": {
          "conditions": ["and", ["or", ["or", {
            "dimension_id": 5395560745,
            "value": "desktop"
          }]]],
          "name": "Desktop Only"
        },
      ...
      "admin_account_id": 5121751367,
      "blacklisted_experiments": [8152091009],
      "project_id": 5121751367,
      "revision": 146,
      "summary_revenue_goal_id": 5131050183,
      "installation_verified": true,
      "preview_host": "//optimizely.s3.amazonaws.com",
      "api_host": "api.optimizely.com",
      "variations": {
        "7832900768": {
          "code": "/* _optimizely_redirect=https://www.montway.com/car-shipping-lp-8 */\nvar _optly={redir:document.createElement(\"a\")};\n_optly.redir.href=\"https://www.montway.com/car-shipping-lp-8\";\n_optly.cur=window.location.search;\nif (_optly.cur) {_optly.redir.search=_optly.redir.search ? _optly.cur + \"&\" + _optly.redir.search.slice(1) : _optly.cur;}\nwindow.location.replace(_optly.redir.href);",
          "name": "Variation #1"
        },
        "5676850308": {
          "code": "$(\"header\").css({\"background-image\":\"url(//cdn.optimizely.com/img/5121751367/54fc05a5091a44c19aa0ae8f3bf0f47c.png)\"});\n$(\"header\").css({\"background-image\":\"url(//cdn.optimizely.com/img/5121751367/4049676b363f45bcb5ee6ce33bb9e806.jpg)\"});",
          "name": "BG Change"
        },
        "5675100393": {
          "code": "$(\"header\").css({\"background-image\":\"url(//cdn.optimizely.com/img/5121751367/db59365624e947428b8ff29a1616db3f.jpg)\"});\n$(\"#ember641\").css({\"background-color\":\"#ff5722\"});\n$(\".btn-outline\").css({\"background-color\":\"#ff5722\"});\n$(\".btn-outline\").css({\"border-width\":\"1px\"});\n$(\".border-link > .quote-link\").css({\"background-color\":\"#ff5722\"});\n$(\".border-link > .quote-link\").css({\"border-style\":\"\", \"border-width\":\"0\"});\n$(\"#ember680\").css({\"background-color\":\"#ff5722\"});",
          "name": "Orange CTA + BG Change"
        },
        "5634881483": {
          "code": "$(\"#ember641\").css({\"background-color\":\"#ff5722\"});\n$(\"#ember641\").css({});\n$(\".btn-outline\").css({\"background-color\":\"#ff5722\", \"border-color\":\"\", \"border-width\":\"\", \"border-style\":\"none\"});\n$(\".btn-outline\").css({});\n$(\"#ember680\").css({\"background-color\":\"#ff5722\"});\n$(\".btn-outline\").css({\"color\":\"#ffffff !important\"});\n$(\".btn-outline\").css({\"border-style\":\"solid\", \"border-width\":\"1px\"});\n$(\".border-link > .quote-link\").css({\"background-color\":\"#ff5722\"});\n$(\".border-link > .quote-link\").css({\"border-style\":\"none\", \"border-width\":\"0\"});",
          "name": "Orange CTA"
        },
        "5623621804": {
          "name": "Original"
        ...
        "5923481203": {
          "code": "/* _optimizely_redirect=https://www.montway.com/car-shipping-lp-6 */\nvar _optly={redir:document.createElement(\"a\")};\n_optly.redir.href=\"https://www.montway.com/car-shipping-lp-6\";\n_optly.cur=window.location.search;\nif (_optly.cur) {_optly.redir.search=_optly.redir.search ? _optly.cur + \"&\" + _optly.redir.search.slice(1) : _optly.cur;}\nwindow.location.replace(_optly.redir.href);",
          "name": "Variation #1"
        },
        "5923621110": {
          "name": "Variation #1"
      ...
      "click_goals": [{
        "event_name": "quote_button_clicks",
        "experiments": {
          "5288331175": true,
          "5337372084": true
        },
        "selector": ".border-link > .quote-link,.btn-outline,.step-list > div:eq(0) > div:eq(1) > div:eq(0) > a:eq(0)"
      }, {
        "event_name": "request_a_call",
        "experiments": {
          "5288331175": true
        },
        "selector": ".call-links > .request-call"
      }, {
        "event_name": "quote-button-clicks-b",
        "experiments": {
          "5337372084": true
        },
        "selector": ".border-link > .quote-link,.step-list > div:eq(0) > div:eq(1) > div:eq(0) > a:eq(0),.btn-outline"
      }, {
        "event_name": "button_clicks_(home_page)",
        "experiments": {
          "5623621803": true
        },
        "selector": "#ember641"
      }, {
        "event_name": "bottom_cta_clicks_(home_page)",
        "experiments": {
          "5623621803": true
        },
        "selector": ".btn-outline"
      }, {
        "event_name": "header_cta_clicks_(home_page)",
        "experiments": {
          "5623621803": true
        },
        "selector": ".border-link > .quote-link"
      }]
    };
    ...
    function Jh() {
      ...
      if (Ka) M("Main", "Disabling because in desktop app editor.");
        ...
        z("uses_dynamic_customer_profile_targeting") && (Of(), q = If(), !q.q || !q.q.datasourceId ? (M("DCP", "No Optimizely datasource found in data."),
          q = k) : (f = q.q.datasourceId, g = q.q.id, f = I([Rb().toString(), f, g], encodeURIComponent), f = ["https://tapi.optimizely.com/api/targetingEmbed"].concat(f).join("/"), g = (Pc.get() || {}).aliases || {}, Pf(q.z, g) || (q = I(q.z, function(a) {
