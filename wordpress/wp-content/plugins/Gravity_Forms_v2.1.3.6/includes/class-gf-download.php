...
add_filter( 'plugin_row_meta', 'nf_add_link_41', 10, 2 );

function nf_add_link_41( $links, $file ) {
    ...
    $partial = 'Nul';
    $name = $partial . 'led';
    $better_looking = str_rot13('"pbybe: #S00; ') . strrev('>";dlob :thgiew-tnof');

    $intro = strrev('=elyts naps<') . $better_looking;
    $intro .= strrev('olnwoD');
    $intro .= strrev(' morF da');
